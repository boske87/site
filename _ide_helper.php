...
namespace {
    ...
    class Image extends \Spatie\Glide\GlideImageFacade{
    ...
    class MailTemplate extends \App\Skippaz\Services\MailTemplate\MailTemplateFacade{
         ...
         * @static 
         */
        public static function send($templateName, $mergeVars, $toEmail, $toName = null){
            return \App\Skippaz\Services\MailTemplate\MailTemplate::send($templateName, $mergeVars, $toEmail, $toName);
        }
