            ...
            <div class="container ">
                <div class="vd_top-nav vd_nav-width  ">
                    <div class="vd_panel-header">
                        <div class="logo">
                            <a href="http://www.venmond.com/demo/vendroid/index.php" style="font-size: 17px">IZVEDI ME</a>
                        </div>
                        <!-- logo -->
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{route('/men.offers')}}">
                                    ...
                                    <span class="menu-text">Sve ponude</span>

                                </a>
                            </li>
                            <li>
                                <a href="{{route('/men.offersAccepted')}}">
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        @if($offer->offerType == 0)
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Tip ponude:</td>
                                                    <td style="font-weight: bold">{{ $offer->offerType == 0 ? 'Izlazak' : 'Putovanje' }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Grad:</td><td style="font-weight: bold">{{$offer->city}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Mesto na koje se izlazi:</td>
                                                    <td style="font-weight: bold">{{$offer->place}}</td>
                                                </tr>
                                                <tr>
