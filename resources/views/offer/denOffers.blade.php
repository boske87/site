                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        @foreach($offers as $oneOffer)
                                            <tr>
                                                <td>{{$oneOffer->offer->offerByMan->name}}</td>
                                                <td>{{$oneOffer->offer->timeOfferStart}}</td>
                                                <td>{{$oneOffer->offer->place}}</td>
                                                <td>{{ $oneOffer->offer->offerType == 0 ? 'Izlazak' : 'Putovanje' }}</td>
                                                <td><a href="{{route('/offersGirlDetails', $oneOffer->offer->id)}}">Detaljno</a></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
