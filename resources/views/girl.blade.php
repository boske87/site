...
<body id="pages" class="full-layout  nav-right-hide nav-right-start-hide  nav-top-fixed      responsive    clearfix breakpoint-975 remove-navbar nav-left-hide" data-active="pages " data-smooth-scrolling="1" style="">
<div class="vd_body">
    <!-- Header Start -->
        ...
        <div class="vd_top-menu-wrapper">
                                ...
                                <div class="vd_mega-menu pull-right">
                                    <ul class="mega-ul">
                                        ...
                                        <li id="top-menu-settings" class="one-big-icon hidden-xs hidden-sm mega-li" data-intro="&lt;strong&gt;Toggle Right Navigation &lt;/strong&gt;&lt;br/&gt;On smaller device such as tablet or phone you can click on the middle content to close the right or left navigation." data-step="2" data-position="left">
                                            <a  class="mega-link" data-action="toggle-navbar-right">
           <span class="mega-icon">
                <i class="fa fa-comments"></i>
                                                ...
                                                <span class="badge vd_bg-red">{{count($offers)}}</span>
                                            </a>
                ...
                <div class="navbar-menu clearfix">
                    <div class="content-list content-image content-chat">
                        <ul class="list-wrapper no-bd-btm pd-lr-10">
                            ...
                            <li>
                                <a href="{{route('/offersGirlDetails', $oneOffer->offer->id)}}">
                                    <div class="menu-icon"><img src="{{ asset('assets/front/admin/men.jpeg')}}" alt="example image"></div>
                                    <div class="menu-text">{{$oneOffer->offer->offerByMan->name}}
                                        <div class="menu-info">
                                            <span class="menu-date">{{$oneOffer->offer->timeOfferStart}} </span>
                                        </div>
                                    </div>
                ...
                <div class="vd_container" style="min-height: 1059px;">
                    <div class="vd_content clearfix">
                        ...
                        <div class="vd_title-section clearfix">
                            <div class="vd_panel-header">
                                <h1>Moj profil -  <a href="{{route('/offersGirl')}}">Moje ponude</a></h1>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="panel widget light-widget">
                                        ...
                                        <form class="form-horizontal" action="http://www.venmond.com/demo/vendroid/pages-user-profile-form.php#" role="form">
                                            <div class="panel-body">
                                                <h2 class="mgbt-xs-20"> Profile: <span class="font-semibold">{{$user->fullName}}</span> </h2>
                                                <br>
                                                <div class="row">
                                                    <div class="col-sm-3 mgbt-xs-20">
                                                        <div class="form-group">
                                                            <div class="col-xs-12">
                                                                <div class="form-img text-center mgbt-xs-15"> <img alt="example image" src="{{ Image::load('gallery/devojka'.$user->id.'/' . $user->images[0]->imageName) }}"> </div>
                                                                <br>
                                                                <div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 controls">
                                                                <div class="row mgbt-xs-0">
                                                                    <div class="col-xs-9">
                                                                        <input type="email" value="{{$user->email}}" disabled placeholder="email@yourcompany.com">
                                                                    </div>
                                                                    <!-- col-xs-12 -->
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 controls">
                                                                <div class="row mgbt-xs-0">
                                                                    <div class="col-xs-9">
                                                                        <input type="text" value="{{$user->fullName}}" disabled placeholder="first name">
                                                                    </div>
                                                                    <!-- col-xs-9 -->
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">Godiste</label>
                                                            <div class="col-sm-9 controls">
                                                                <div class="row mgbt-xs-0">
                                                                    <div class="col-xs-9">
                                                                        <input type="text" value="{{$user->year}}" disabled placeholder="Godiste">
                                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 controls">
                                                                <div class="row mgbt-xs-0">
                                                                    <div class="col-xs-9">
                                                                        <input type="text" value="{{$user->city}}" disabled placeholder="grad">
                                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">Jezici</label>
                                                            <div class="col-sm-9 controls">
                                                                <div class="row mgbt-xs-0">
                                                                    <div class="col-xs-9">
                                                                        <input type="text" value="{{$user->lang}}" disabled placeholder="Jezici">
                                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">Zanimanje</label>
                                                            <div class="col-sm-9 controls">
                                                                <div class="row mgbt-xs-0">
                                                                    <div class="col-xs-9">
                                                                        <input type="text" value="{{$user->job}}" disabled placeholder="Zanimanje">
                                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">Visina</label>
                                                            <div class="col-sm-9 controls">
                                                                <div class="row mgbt-xs-0">
                                                                    <div class="col-xs-9">
                                                                        <input type="text" value="{{$user->height}}" disabled placeholder="Visina">
                                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">Tezina</label>
                                                            <div class="col-sm-9 controls">
                                                                <div class="row mgbt-xs-0">
                                                                    <div class="col-xs-9">
                                                                        <input type="text" value="{{$user->weight}}" disabled placeholder="Tezina">
                                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9 controls">
                                                                <div class="row mgbt-xs-0">
                                                                    <div class="col-xs-9">
                                                                        <input type="text" value="{{$user->phone}}" disabled placeholder="mobile phone">
                                                                    </div>
                                                                    <!-- col-xs-12 -->
                                                                </div>
                                                                <!-- row -->
...
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.ui.widget.js')}}"></script>
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.iframe-transport.js')}}"></script>
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.fileupload.js')}}"></script>
<!-- The Load Image plugin is included for the preview images and image resizing functionality -->
<script type="text/javascript" src="{{ asset('assets/front/admin/load-image.min.js')}}"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script type="text/javascript" src="{{ asset('assets/front/admin/canvas-to-blob.min.js')}}"></script>
<!-- The Iframe Transport is required for browsers without support for XHR file uploads -->
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.iframe-transport.js')}}"></script>
<!-- The File Upload processing plugin -->
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.fileupload-process.js')}}"></script>
<!-- The File Upload image preview & resize plugin -->
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.fileupload-image.js')}}"></script>
<!-- The File Upload audio preview plugin -->
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.fileupload-audio.js')}}"></script>
<!-- The File Upload video preview plugin -->
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.fileupload-video.js')}}"></script>
<!-- The File Upload validation plugin -->
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.fileupload-validate.js')}}"></script>
<!-- The File Upload UI plugin -->
<script type="text/javascript" src="{{ asset('assets/front/admin/jquery.fileupload-ui.js')}}"></script>
