                ...
                <div class="navbar-menu clearfix">
                    <div class="content-list content-image content-chat">
                        <ul class="list-wrapper no-bd-btm pd-lr-10">
                            <li>
                                <a href="http://www.venmond.com/demo/vendroid/pages-user-profile-form.php#">
                                    <div class="menu-icon"><img src="{{ asset('assets/front/admin/avatar.jpg')}}" alt="example image"></div>
                            ...
                            <li>
                                <a href="http://www.venmond.com/demo/vendroid/pages-user-profile-form.php#">
                                    <div class="menu-icon"><img src="{{ asset('assets/front/admin/avatar-2.jpg')}}" alt="example image"></div>
                            ...
                            <li>
                                <a href="http://www.venmond.com/demo/vendroid/pages-user-profile-form.php#">
                                    <div class="menu-icon"><img src="{{ asset('assets/front/admin/avatar-3.jpg')}}" alt="example image"></div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="col-xs-12">
                                                                <div class="form-img text-center mgbt-xs-15">
                                                                    <div class="flexslider">
                                                                        <ul class="slides">
                                                                            @foreach($user->images as $one)
                                                                            <li>
                                                                                <a class="fancybox" rel="group" href="{{ Image::load('gallery/devojka'.$user->id.'/' . $one->imageName) }}">
                                                                                <img src="{{ Image::load('gallery/devojka'.$user->id.'/' . $one->imageName) }}" />
                                                                                </a>
                                                                            </li>
                                                                            @endforeach
                                                                        </ul>
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label">Nadimak</label>
...
<script defer src="https://cdnjs.cloudflare.com/ajax/libs/flexslider/2.7.0/jquery.flexslider.js"></script>
